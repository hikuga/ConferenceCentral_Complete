...
class Profile(ndb.Model):
    ...
    sessionKeysWishToAttend = ndb.StringProperty(repeated=True)
...
class ProfileForm(messages.Message):
    ...
    sessionKeysWishToAttend = messages.StringField(5,  repeated=True)
...
class Session(ndb.Model):
    ...
    parentConference=ndb.StringProperty()
...
class SessionForm(messages.Message):
    ...
    parentConference=messages.StringField(6, required=True)
